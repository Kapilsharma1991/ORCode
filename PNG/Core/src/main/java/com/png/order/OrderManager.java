...
public class OrderManager {
	...
	public void repriceOrder(Order order) {
		...
		getPricingEngine().repriceOrder(order);
	...
	public void repriceOrder(String shippingGroupId, OrderPriceInfo priceInfo) {
		...
		getPricingEngine().repriceOrder(shippingGroupId, priceInfo);
	...
	public OrderPriceInfo repriceOrder(List<Booking> bookings) {
		...
		OrderPriceInfo priceInfo = getPricingEngine().repriceOrder(bookings);
		return priceInfo;
	}
